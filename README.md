...
> Flutter Task App 1: Cross-platform task manager with Flutter, FastAPI, and PostgreSQL
...
git clone https://github.com/elitsuri/flutter-task-app-1
cd flutter-task-app-1
